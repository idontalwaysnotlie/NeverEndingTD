...
function BuildingHelper:AddBuilding(keys)
    ...
    local sss = CreateUnitByName(unitName, OutOfWorldVector, false, nil, nil, builder:GetTeam())
	sss.ACost = sss.GoldCost
	print("Building1 "..sss:GetName())
	print(sss.ACost)
	player.activeBuildingTable.mgd = sss
	print("unit:")
	print(unitName)
	print(builder:GetTeam())
	print(OutOfWorldVector)
	DeepPrintTable(sss)
...
function BuildingHelper:PlaceBuilding(player, name, location, blockGridNav, size, angle)
	...
	print("placing building:"..name.." at location:")
	print(location)
