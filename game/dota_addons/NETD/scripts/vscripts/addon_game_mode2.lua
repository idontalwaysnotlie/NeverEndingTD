...
function CHoldoutGameMode:InitGameMode()
	...
	GameRules:SendCustomMessage("DOTA_Tooltip_ability_item_bag_of_gold",1,1)
	GameRules:SendCustomMessage("DOTA_Tooltip_ability_item_bag_of_gold",3,1)
	GameRules:SendCustomMessage("DOTA_Tooltip_ability_item_bag_of_gold",0,1)
	GameRules:SendCustomMessage("DOTA_Tooltip_ability_item_bag_of_gold",2,1)
